...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      vim.diagnostic.config {
        ...
        signs = true, -- Show diagnostic signs in the sign column (optional, but common)
  ...
  },
  {
    ...
    build = ':TSUpdate',
    config = function()
      -- NOTE: Notice we require 'nvim-treesitter' directly, NOT 'nvim-treesitter.configs'
...
vim.keymap.set('n', '<leader>gvd', vim.cmd.Gvdiffsplit)
...
harpoon:extend {
  UI_CREATE = function(cx)
    vim.keymap.set('n', '<Esc>', function()
      vim.keymap.set('n', '<Esc>', '<cmd>wq<cr>', { buffer = cx.bufnr })
    end, { buffer = cx.bufnr })
  end,
}
